  ...
  const body = (
    <div className="space-y-4">
      ...
      {listing && (
        <div className="rounded-lg border border-primary/30 bg-primary/5 p-4">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            for <span className="font-mono font-semibold text-foreground">{avn(listing.priceSats)} AVN</span>
          </p>
        </div>
      )}
      ...
      <div className="space-y-2">
        ...
        <p className="break-all rounded-md border bg-muted/20 p-2 font-mono text-xs">
          {listing?.payTo ?? account}
        </p>
      </div>
